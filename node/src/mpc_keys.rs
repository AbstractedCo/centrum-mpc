...
pub struct PublicKey(pub <Kem as hpke::Kem>::PublicKey);

impl From<super::on_chain::MpcKeysPublicKey> for PublicKey {
    fn from(value: super::on_chain::MpcKeysPublicKey) -> Self {
        Self(value.into_mpc_public_key())
    }
}
...
pub struct EncappedKey(pub <Kem as hpke::Kem>::EncappedKey);
...
pub fn derive(seed: &[u8]) -> (SecretKey, PublicKey) {
